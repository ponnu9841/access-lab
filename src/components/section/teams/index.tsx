...
export default function Team({ heading }: { heading: Heading[] }) {
  const dispatch = useAppDispatch();
  const { loading, data } = useAppSelector((state) => state.rootReducer.teams);
  const teamsHeading = getCurrentSectionHeading(heading, "teams");
  ...
  return (
    <>
      ...
      <Heading
        title={teamsHeading?.title || "Meet Our Dedicated Team"}
